...
book_5 = Book(name='Убить пересмешника', author='Харпер Ли', number_of_pages=284, isbn=4569087, reservation=False)
...
class SchoolBook(Book):
    ...
    def __init__(self, name, author, number_of_pages, isbn, subject, year, reservation):
